...
+ (void)addUserWithUsername:(NSString *)username
    ...
    NSDictionary *params = @{@"client_id":client, @"secret":secret, @"credentials":@{@"username":username, @"password":password}, @"type":type, @"options":@{@"webhook":webhook, @"login_only":@(login_only)}};
